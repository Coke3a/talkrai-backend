...
use crate::usecases::roleplay::prompt::wrap_character_content;
pub use crate::usecases::roleplay::prompt::{
    build_ai_messages, build_system_prompt, compact_atmosphere,
};
...
mod tests {
    ...
    use crate::domain::services::roleplay_text::blocks_json_to_text_markup;
    use crate::domain::value_objects::*;
